    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6">
                    <h1 class="m-0">create demande</h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
                    ...
                    <div class="col-6 mx-auto">
                        <div class="form-group col-7 mx-auto">
                            ...
                            <select class="form-control" style="width: 100%;" id="choix" name="motif" disabled>
                                <option selected value="logiciel">logiciel</option>
                            </select>
                            <input type="hidden" name="motif" value="logiciel"/>
                        </div> 
                    </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-7 mx-auto">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="date" value="{{\Carbon\Carbon::now()->format('20y-m-d')}}" class="form-control text-center" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask>
                                    </div>
                                </div>
                            </div>
                        </div>                   
